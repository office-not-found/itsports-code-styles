...
- [Рекомендации по тестированию](#рекомендации-по-тестированию)
  - [Философия: тестируйте только то, что экономит время](#философия-тестируйте-только-то-что-экономит-время)
  - [Когда стоит писать тесты](#когда-стоит-писать-тесты)
  - [Типы тестов](#типы-тестов)
  - [Практический подход к тестированию](#практический-подход-к-тестированию)
...
- [Git Workflow](#git-workflow)
  ...
  - [Naming веток](#naming-веток)
  - [Pre-commit hooks](#pre-commit-hooks)
- [Архитектура проекта](#архитектура-проекта)
  - [Выбор архитектуры](#выбор-архитектуры)
  - [FSD (Feature-Sliced Design) - для больших проектов](#fsd-feature-sliced-design---для-больших-проектов)
  - [Модульная архитектура - для маленьких/средних проектов](#модульная-архитектура---для-маленькихсредних-проектов)
  - [Алиасы путей](#алиасы-путей)
- [Переменные окружения](#переменные-окружения)
- [Полезные ссылки](#полезные-ссылки)
  - [Документация основных технологий](#документация-основных-технологий)
  - [UI и стили](#ui-и-стили-1)
  - [Формы и валидация](#формы-и-валидация)
  - [Инструменты разработки](#инструменты-разработки-1)
...
- **Зависимость от ядра** - модули используют общие сервисы из `shared/` или `core/`, не зависят друг от друга напрямую
...
src/
  ...
  └── shared/ (или core/)   # Общая инфраструктура
...
- **`modules/`** - бизнес-модули с собственной структурой (api, lib, model, query, ui)
  ...
  ```
- **`core/`** или **`shared/`** - переиспользуемая инфраструктура:
...
> **Примечание:** В разных проектах используется либо `core/`, либо `shared/` для общей инфраструктуры. Оба варианта допустимы - выбирайте то название, которое лучше отражает назначение папки для вашей команды.
...
```typescript
// Импорт UI-компонента (из shared или core в зависимости от проекта)
